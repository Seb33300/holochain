...
mod tests {
    ...
    //     expect.insert(ZomeId(0), ScopedZomeTypes { entries: e, links: l });
    ...
    //     expect.insert(ZomeId(2), ScopedZomeTypes { entries: e, links: l });
    ...
    //     expect.insert(ZomeId(3), ScopedZomeTypes { entries: e, links: l });

    //     assert_eq!(
    //         GlobalZomeTypes::from_ordered_iterator(zome_types).unwrap(),
    //         GlobalZomeTypes(expect)
    //     )
    }
}
